...
int main(void) {
	...
	char ch, text[] = "I think I'm left with none but pain";
	char ch1, text1[] = "We'll eat cake by the ocean";
	char ch2, text2[] = "so I look in your smile and see the days we gave nothing but love";
